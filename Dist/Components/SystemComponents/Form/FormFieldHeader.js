...
var FormFieldHeader = function (_a) {
    var rest = __rest(_a, []);
    var className = rest.className;
    var children = rest.children;
    delete rest.className;
    delete rest.children;
    var classNames = joinStrings(['form-field-header', className]);
    var restProps = !Object.keys(rest).length ? [] : rest;
    return (React.createElement("div", __assign({ className: classNames }, restProps), children));
};
